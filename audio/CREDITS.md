...
## KitiKat caption voice

Original project captions synthesized locally using KittenML KittenTTS Nano 0.8
(fp32, 15M parameters), voice Kiki. Model: https://huggingface.co/KittenML/kitten-tts-nano-0.8-fp32
Code: https://github.com/KittenML/KittenTTS (Apache-2.0).
Pinned model/code revisions and encoding are recorded in kitten/provenance.json.
These are prerecorded synthetic speech clips, not a cloned person's voice.
No speech model, Python runtime or phonemizer is distributed to visitors.
